...
- (void)selectionButtonPressed {
    if ([_gridController.browser.delegate respondsToSelector:@selector(selectedCountPhotoBrowser:)]) {
        NSInteger count = [_gridController.browser.delegate selectedCountPhotoBrowser:_gridController.browser];
        if (count >= _gridController.browser.maxSelectedCount && _selectedButton.selected == NO) {
            
            if ([_gridController.browser.delegate respondsToSelector:@selector(reachMaxSelectedCountPhotoBrowser:)]) {
                [_gridController.browser.delegate reachMaxSelectedCountPhotoBrowser:self];
            }
